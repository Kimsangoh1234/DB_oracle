...
---A513079,A513090,A513091,A513119
--WHERE IN 학생이름 내림차순
--TB_STUDENT
SELECT STUDENT_NAME 
FROM TB_STUDENT
WHERE STUDENT_NO IN('A513079','A513090','A513091','A513119')
ORDER BY STUDENT_NAME DESC;

--6
--춘 기술대학교는 총장을 제외하고 모든 교수들이 소속학과를 가지고 있음
--춘 기술대학교 총장의 이름을 알아낼 수 있는 SQL 문장 작성
SELECT*FROM TB_PROFESSOR;
SELECT PROFESSOR_NAME
FROM TB_PROFESSOR
WHERE department_no IS NULL;
--7. 수강신청을 하려고 한다. 선수과목 여부를 확이하는데
--선수과목이 존재하는 과목들
...
--14
--춘 기술대학교의 2000년도 이후 입학자들은 학번이 A로 시작하게 되있음
...
SELECT*FROM TB_GRADE;
SELECT SUBSTR(TERM_NO,1,4)AS"년도",ROUND(AVG(POINT),1)AS"년도별평점"
FROM TB_GRADE
