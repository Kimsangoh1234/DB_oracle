 ...
 *권한의 종류
 ...
 RESOURCE : 사용자가 객체(테이블,뷰,인덱스)를 생성할 수 있도록 하기 위해 시스템 권한을 묶어놓음
        -> 권한 5가지 묶음 패키지
          CLUSTER, PROCEDURE,TABLE,TRIGGER
 
 DBA       : 시스템 관리에 필요한 모든 권한을 부여하는 강력한 설정(최고설정)
*/
