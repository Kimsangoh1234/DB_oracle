...
포괄 조인 --> 왼쪽 외부 조인(LEFT OUTER),오른쪽 외부 조인(RIGHT OUTER), XLQ



*/

--1. 서로 다른 테이블 데이터를 조회할 경우 2ㄱ가지로 나ㅜ눠서 조회
...
--JOIN을 활용해서 EMPLOYEE 테이블과 DEPARTMET 테이블 한 번에 조회
/*
...
기준 테이블 옆에 한 행씩 묻어나가는것
/*
EMPLOYEE 테이블과 DEPARTMENT 테이블을 조인해서
직원 ID, 이름, 부서코드,부서

JOIN DEPARTMENT ON(DEPT_CODE=DEPT_ID);
EMP_ID,EMP_NAME,DEPT_CODE,DEPT_ID,DEP,O
200	선동일	D9	D9	총무부
201	송종기	D9	D9	총무부
202	노옹철	D9	D9	총무부/*
*/
