...
----[ 자료형 ]
        ...
        VARCAHR(10) 컬럼 : VARCHAR2 3만큼만 소진 나머지 7은 반환
...
--아이디 : USER_ID / 자료형 VARCHAR(20)

--비밀번호 : USER_PW / 자료형 VARCHAR(20)

-- 이름 : USER_NAME / 자료형 VARCHAR2(15) --한글 5글짜가지 OK

--주민번호 : USER_SSN / 자료형CHAR(14)           --14글자 고정
