...
FROM JOB;
--> JOB테이블에는 급여가 없기 때문에 에러 발생

--3) 1)과2)의 쿼리를 합해서 조회
SELECT JOB_NAME,(SELECT JOB_NAME,AVG(SALARY)FROM EMPLOYEE2)
FROM JOB;
