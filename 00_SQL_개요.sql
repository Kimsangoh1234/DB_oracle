...
RESOURCE : 테이블, 인덱스, 뷰 등을 생성할 수 있는 권한
        -> T 반에서 특정 행동이나 만들기 변경 설정할 수 있는 권한
이외 여러가지 권한 있음 권한을 여러가지 한 번에 작성할 때는 , 사용해서
작성
...
/*
    테이블을 생성하기
테이블이란? 데이터 베이스에서 모든 데이터를 포함하는 공간
...
INSERT INTO MEMBER (M_ID, M_NAME, M_AGE, M_PHONE, M_DATE) VALUES (3, '김철수', '32', '1234567890','2024-05-03');

INSERT INTO MEMBER (M_ID, M_NAME, M_AGE, M_PHONE, M_DATE) VALUES (4, '이영희', '37', '1234567890','2024-05-04');

INSERT INTO MEMBER (M_ID, M_NAME, M_AGE, M_PHONE, M_DATE) VALUES (5, '최민수', '37', '1234567890','2024-05-05');

INSERT INTO MEMBER (M_ID, M_NAME, M_AGE, M_PHONE, M_DATE) VALUES (6, '최민수', '37', '1234567890','2024-05-06');
